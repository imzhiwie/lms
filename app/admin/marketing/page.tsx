...
const mockUsers: User[] = [
  { id: "1", name: "Dr. Sarah Johnson", email: "sarah.johnson@hospital.com", role: "faculty", status: "active" },
  { id: "2", name: "Dr. Michael Chen", email: "michael.chen@clinic.com", role: "student", status: "active" },
  { id: "3", name: "Dr. Emily Rodriguez", email: "emily.rodriguez@medical.com", role: "student", status: "active" },
  { id: "4", name: "Dr. James Wilson", email: "james.wilson@hospital.com", role: "faculty", status: "active" },
  { id: "5", name: "Dr. Lisa Thompson", email: "lisa.thompson@clinic.com", role: "student", status: "pending" },
  { id: "6", name: "Admin User", email: "admin@radiologylms.com", role: "admin", status: "active" },
]
