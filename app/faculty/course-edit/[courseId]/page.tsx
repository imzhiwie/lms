...
import { CourseBasicsTab } from "@/components/course-edit/course-basics-tab"
import { CourseCurriculumTab } from "@/components/course-edit/course-curriculum-tab"
import { CourseSettingsTab } from "@/components/course-edit/course-settings-tab"
import { CourseStudentsTab } from "@/components/course-edit/course-students-tab"
import { CourseAnalyticsTab } from "@/components/course-edit/course-analytics-tab"
import { CourseMessagesTab } from "@/components/course-edit/course-messages-tab"
...
export default function CourseEditPage() {
    ...
    const loadCourse = async () => {
        try {
            ...
            const response = await axios.post('http://35.247.179.125/lms-api/get-course-data', {
                user_id: "1",
                course_id: courseId,
            });
